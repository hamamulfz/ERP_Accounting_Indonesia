<div class="page-header">
    <h3>New Leadership Competency</h3>
</div>
...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->dropDownListRow($model,'talent_template_id',gParamCompetency::leadershipDropDown(), 
		array('class'=>'span5','maxlength'=>50)); ?>
	...
	<div class="form-actions">
		...
		<?php $this->widget('bootstrap.widgets.TbButton', array(
			'type'=>'primary',
			'url'=>Yii::app()->createUrl('/m1/gTalent/generateLeadershipCompetency',array('id'=>$id)),
			'label'=>'Generate All',
		)); ?>
