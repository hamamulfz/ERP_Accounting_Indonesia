            ...
            <div class="span6">
                ...
                $this->Widget('ext.highcharts.HighchartsWidget', array(
                    'options' => array(
                        ...
                        'series' => array(
                            array('name' => 'Age', 'data' => gPerson2::compAgeAll())
                        ),
                        'plotOptions' => array(
                            'column' => array(
                                'dataLabels' => array(
            ...
            <div class="span4">
                ...
                $this->Widget('ext.highcharts.HighchartsWidget', array(
                    'options' => array(
                        ...
                        'series' => array(
                            array('name' => 'Sex', 'data' => gPerson2::compSexAll())
                        ),
                        'plotOptions' => array(
                            'column' => array(
                                'dataLabels' => array(
            ...
            <div class="span5">
                ...
                $this->Widget('ext.highcharts.HighchartsWidget', array(
                    'options' => array(
                        ...
                        'series' => array(
                            array('name' => 'Religion', 'data' => gPerson2::compReligionAll())
                        ),
                        'plotOptions' => array(
                            'column' => array(
                                'dataLabels' => array(
            ...
            <div class="span5">
                ...
                $this->Widget('ext.highcharts.HighchartsWidget', array(
                    'options' => array(
                        ...
                        'series' => array(
                            array('name' => 'Education', 'data' => gPerson2::compEducationAll())
                        ),
                        'plotOptions' => array(
                            'column' => array(
                                'dataLabels' => array(
