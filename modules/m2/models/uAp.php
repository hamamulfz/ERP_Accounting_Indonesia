...
class uAp extends BaseModel
{
	...
	public function relations()
	{
		...
		return array(
            'po' => array(self::HAS_ONE, 'uPo', 'id'),
            'entity' => array(self::BELONGS_TO, 'aOrganization', 'entity_id'),
            'payment' => array(self::HAS_MANY, 'uApPayment', 'parent_id'),
            'paymentSum' => array(self::STAT, 'uApPayment', 'parent_id', 'select' => 'sum(amount)'),
		);
	}
	...
	public function onHalfPaid()
	{
		...
		$criteria=new CDbCriteria;
		$criteria->with=array('po','payment');
